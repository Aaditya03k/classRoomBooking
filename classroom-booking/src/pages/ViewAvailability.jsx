...
const ViewAvailability = () => {
  ...
  useEffect(() => {
    const fetchRooms = async () => {
      try {
        ...
        const res = await fetch("https://classroombook-ghfph7eacsh2eecz.centralindia-01.azurewebsites.net/rooms", {
          headers: {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch("https://classroombook-ghfph7eacsh2eecz.centralindia-01.azurewebsites.net/bookings", {
        method: "POST",
        headers: {
