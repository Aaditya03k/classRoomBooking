...
const ManageBookings = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        const res = await fetch("https://classroombook-ghfph7eacsh2eecz.centralindia-01.azurewebsites.net/bookings/mybookings", {
          headers: {
  ...
  const handleCancel = async (bookingId) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`https://classroombook-ghfph7eacsh2eecz.centralindia-01.azurewebsites.net/bookings/${bookingId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
